...
export const DESTINATION_TAGS = {
  ...
  ATH: { audiences: ['couples', 'families', 'friends'], types: ['city', 'nature', 'culture'] },
  BCN: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'beach', 'shopping', 'culture'] },
  BEG: { audiences: ['friends', 'solo'], types: ['city'] },
  BER: { audiences: ['solo', 'friends'], types: ['city', 'shopping', 'culture'] },
  BKK: { audiences: ['solo', 'friends'], types: ['city', 'shopping'] },
  BOM: { audiences: ['solo'], types: ['city'] },
  BUD: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'culture'] },
  BUS: { audiences: ['couples', 'friends'], types: ['beach', 'city'] },
  CDG: { audiences: ['couples'], types: ['city', 'shopping', 'culture'] },
  ...
  FCO: { audiences: ['couples', 'families'], types: ['city', 'culture'] },
  GOI: { audiences: ['couples', 'friends', 'solo'], types: ['beach'] },
  HER: { audiences: ['families', 'couples'], types: ['beach', 'nature'] },
  IST: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'shopping', 'culture'] },
  KRK: { audiences: ['friends', 'solo'], types: ['city', 'culture'] },
  LCA: { audiences: ['families', 'couples'], types: ['beach'] },
  LHR: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'shopping', 'culture'] },
  LIS: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'beach'] },
  MAD: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'shopping', 'culture'] },
  MLE: { audiences: ['couples'], types: ['beach'] },
  MXP: { audiences: ['couples', 'solo'], types: ['city', 'shopping'] },
  NAP: { audiences: ['families', 'couples'], types: ['city', 'nature', 'culture'] },
  OTP: { audiences: ['friends', 'solo'], types: ['city'] },
  PMI: { audiences: ['families', 'friends', 'couples'], types: ['beach'] },
  PRG: { audiences: ['couples', 'friends', 'solo'], types: ['city', 'culture'] },
  ...
  VCE: { audiences: ['couples'], types: ['city', 'culture'] },
  VIE: { audiences: ['couples', 'solo'], types: ['city', 'shopping', 'culture'] },
