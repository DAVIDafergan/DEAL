...
export const propertyApi = {
  ...
  duplicate: (token, id) => postJson(`/properties/${id}/duplicate`, {}, token),
  reportInfo: (id, reason, details) => postJson(`/properties/${id}/report-info`, { reason, details }, null),
...
export const uploadApi = {
  ...
  deletePropertyVideo: (token, url, propertyId) => deleteReq(`/uploads/property-video?url=${encodeURIComponent(url)}&propertyId=${propertyId}`, token),
};
...
export const adminApi = {
  ...
  getInfoReports: (tok) => getJson('/admin/info-reports', tok),
  dismissInfoReport: (tok, id) => deleteReq(`/admin/info-reports/${id}`, tok),
