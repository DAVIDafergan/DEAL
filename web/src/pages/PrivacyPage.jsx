    ...
    <div className="legal-page" dir="rtl">
      <div className="legal-page__inner container">
        ...
        <section className="legal-section">
          ...
          <p>בעת הרשמה כבעל צימר/וילה אנו אוספים: שם עסק, שם איש קשר, כתובת דוא"ל, מספר טלפון ו-WhatsApp.</p>
          <p>בעת הרשמה כלקוח (לצורך שמירת מועדפים, התראות והזמנות) אנו אוספים: שם וכתובת דוא"ל, וסיסמה
            מוצפנת (או, בהתחברות עם Google, שם ודוא"ל בלבד ללא סיסמה). גולש שאינו נרשם יכול להמשיך
            לחפש ולעיין בנכסים ללא כל רישום ומבלי שנאספים עליו נתונים מזהים.</p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>לקוחות ובעלי נכסים רשאים לבקש עיון, תיקון או מחיקה של המידע האישי שלהם בכל עת. מחיקת חשבון
            לקוח זמינה עצמאית באזור האישי; בעלי נכסים ופניות נוספות — באמצעות פנייה לכתובת הדוא"ל שלהלן.</p>
        </section>

        <section className="legal-section">
          <h2>6. שינויים במדיניות</h2>
          <p>Dealim רשאית לעדכן מדיניות זו. עדכונים מהותיים יימסרו למשתמשים רשומים בדוא"ל.</p>
        </section>
